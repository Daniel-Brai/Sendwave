...
function showToast(message, type) {
  if (type === 'success') {
    ...
    messageBlock.innerHTML = `
                <div id="toast-warning" class="flex items-center w-full max-w-xs p-4 mb-4 mx-auto text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
changePasswordForm.addEventListener('htmx:afterRequest', function (event) {
