const saveContactsForm = document.getElementById('create-contact-form');
...
saveContactsForm.addEventListener('htmx:afterRequest', function (event) {
  const response = JSON.parse(event.detail.xhr.response);
  const message = response['message'];
  const success_message = 'Contact saved successfully';
